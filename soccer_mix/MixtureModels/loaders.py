...
# Hugo's Data PATH
PATH = '/home/gabriel/ic-SALab/Wyscout'
...
class SPADLLoader(d6t.tasks.TaskCSVPandas):
    ...
    def run(self):
        matches_general = self.input()['matches']['matches_general'].load()
        ...
        for g in tqdm(game_ids):
            ...
            match_actions = spadl.play_left_to_right(events=match_events, home_team_id=match_home_id)
